...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  function renderCategoryLabel() {
      ...
      label = 
        <>
          <img
            ...
            className="emoji"
            alt="☹️"
            src="https://s.w.org/images/core/emoji/17.0.2/svg/2639.svg"
          />{" "}
          Sold Out{" "}
        </>;
      ...
      label = (
        <>
          <img
            ...
            className="emoji"
            alt="😲"
            src="https://s.w.org/images/core/emoji/17.0.2/svg/1f632.svg"
          />{" "}
          Less than {percent}% left{" "}
        </>
      );
    }
    ...
    return (
      <div
        className={`product-category-text-img ${progressPercent === 0 ? "sold-out red-bg" : ""}`}
      >
        {label}
      </div>
    );
          ...
          <div className="product-card-lower">
            ...
            <div className="product-category-btn-home">
              ...
              <Link href={href} className="enter-now-btn">
                ...
                {ticketSalesDisabled ? "Read More" : "Enter Now"}
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="desc text-left">
          ...
          <div className="product-card-lower">
            <div className="ticket-block tickets-box-rs">
              ...
              <div className="progress">
                <div
                  className="progress-bar loader-progress-bar"
                  style={{ width: `70%` }}
                >
