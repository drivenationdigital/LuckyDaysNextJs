...
import {
  ...
  IOrderItem,
  WinningNumbers,
} from "../myaccount/AccountViewOrder";
...
export default function OrderReceived({ order_id }: Props) {
  ...
  useEffect(() => {
    // Clean login_token from URL after the server has already consumed it
            ...
            <div className="container">
              <div className="woocommerce-order custom-thankyou">
                ...
                <p>
                  ...
                  minutes. Please check your junk mail if you can&apos;t see it.{" "}
                  <Link
                    style={{ color: "#00a0b9" }}
