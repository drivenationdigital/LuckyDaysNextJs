            ...
            <main className="content-page">
                <div className="container text-center">
                    <div className="col-sm-12">
                        ...
                        <p>Welcome to Ace Competition Ltd trading as Lucky Day Competition’s privacy policy.</p>
                        <p>Lucky Day Competitions respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we process and look after your personal data when you visit our website (regardless of where you visit it from).</p>
                        <p>It also tells you about your privacy rights and how the law protects you.</p>
                        <p>You can download a pdf version of the policy here: ( <a href="https://www.luckydaycompetitions.com/wp-content/uploads/2020/10/Privacy-Policy.pdf"><em>https://www.luckydaycompetitions.com/wp-content/uploads/2020/10/Privacy-Policy.pdf</em></a> ).</p>
                        <p>Please also use the Glossary to understand the meaning of some of the terms used in this privacy policy.</p>
                        <ol>
                            <li><a ></a>Important information and who we are</li>
                        </ol>
                        <p>&nbsp;</p>
                        <p><strong>Purpose of this privacy policy</strong></p>
                        <p>This privacy policy aims to give you information on how Lucky Day Competitions collect and processes your personal data through your use of this website, including any data you may provide through this website when you sign up to our newsletter, purchase any products or services or take part in a prize draw or competition.</p>
                        ...
                        <p>Ace Competitions Limited is the controller and responsible for your personal data (collectively referred to as Lucky Day Competitions, “we”, “us” or “our” in this privacy policy).</p>
                        ...
                        <p>Full name of legal entity: Ace Competition Ltd</p>
                        <p>Email address: <a href="mailto:info@luckydaycompetitions.com"><em>info@luckydaycompetitions.com</em></a></p>
                        <p>Postal address: 72 Tievecrom Road, Forkhill, Newry, Co. Down, BT35 9RX</p>
                        <p>Telephone number: 0330 043 0543</p>
                        ...
                        <p>We keep our privacy policy under regular review. This version was last updated on 23.10.20.</p>
                        <p>It is important that the personal data we hold about you is accurate and current. Please keep us informed if your personal data changes during your relationship with us.</p>
                        <p>&nbsp;</p>
                        <p><strong>Third-party links</strong></p>
                        <p>This website may include links to third-party websites, plug-ins and applications. Clicking on those links or enabling those connections may allow third parties to collect or share data about you. We do not control these third-party websites and are not responsible for their privacy statements. When you leave our website, we encourage you to read the privacy policy of every website you visit.</p>
                        <ol start={2}>
                            <li><a ></a>The data we collect about you</li>
                        </ol>
                        <p>Personal data, or personal information, means any information about an individual from which that person can be identified. It does not include data where the identity has been removed (anonymous data).</p>
                        <p>We may collect, use, store and transfer different kinds of personal data about you which we have grouped together as follows:</p>
                        <ul>
                            <li>Identity Data includes first name, last name, username or similar identifier and title..</li>
                        ...
                        <p>&nbsp;</p>
                        <ol start={3}>
                            <li><strong><a ></a>How is your personal data collected?</strong></li>
                        </ol>
                        ...
                        <ul>
                            ...
                            <li>Automated technologies or interactions. As you interact with our website, we will automatically collect Technical Data about your equipment, browsing actions and patterns. We collect this personal data by using cookies, server logs and other similar technologies. We may also receive Technical Data about you if you visit other websites employing our cookies. Please see our cookie policy ( <a href="https://www.luckydaycompetitions.com/terms-of-use/#cookies"><em>https://www.luckydaycompetitions.com/terms-of-use/#cookies</em></a> ) for further details.</li>
                            <li>Third parties or publicly available sources. We will receive personal data about you from various third parties and public sources as set out below:</li>
                        ...
                        <ol start={4}>
                            <li><strong><a ></a>How we use your personal data</strong></li>
                        </ol>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td width="237">Purpose/Activity</td>
                                    <td width="184">Type of data</td>
                                    <td width="291">Lawful basis for processing including basis of legitimate interest</td>
                                </tr>
                                <tr>
                                    <td width="237">To register you as a new customer</td>
                                    <td width="184">(a) Identity<p></p>
                                        <p>(b) Contact</p></td>
                                    <td width="291">Performance of a contract with you</td>
                                </tr>
                                <tr>
                                    <td width="237">To process and deliver your order including:<p></p>
                                    ...
                                    <td width="291">(a) Performance of a contract with you<p></p>
                                        <p>(b) Necessary for our legitimate interests (to recover debts due to us)</p></td>
                                </tr>
                                <tr>
                                    <td width="237">To manage our relationship with you which will include:<p></p>
                                ...
                                <tr>
                                    <td width="237">To enable you to partake in a prize draw, competition or complete a survey</td>
                                    <td width="184">(a) Identity<p></p>
                                        <p>(b) Contact</p>
                                        <p>(c) Profile</p>
                                        <p>(d) Usage</p>
                                        <p>(e) Marketing and Communications</p></td>
                                    <td width="291">(a) Performance of a contract with you<p></p>
                                        <p>(b) Necessary for our legitimate interests (to study how customers use our products/services, to develop them and grow our business)</p></td>
                                </tr>
                                <tr>
                                    <td width="237">To administer and protect our business and this website (including troubleshooting, data analysis, testing, system maintenance, support, reporting and hosting of data)</td>
                                    <td width="184">(a) Identity<p></p>
                                        <p>(b) Contact</p>
                                        <p>(c) Technical</p></td>
                                    <td width="291">(a) Necessary for our legitimate interests (for running our business, provision of administration and IT services, network security, to prevent fraud and in the context of a business reorganisation or group restructuring exercise)<p></p>
                                ...
                                <tr>
                                    ...
                                    <td width="184">(a) Identity<p></p>
                                        ...
                                        <p>(f) Technical</p></td>
                                    <td width="291">Necessary for our legitimate interests (to study how customers use our products/services, to develop them, to grow our business and to inform our marketing strategy)</td>
                                </tr>
                                <tr>
                                    <td width="237">To use data analytics to improve our website, products/services, marketing, customer relationships and experiences</td>
                                    <td width="184">(a) Technical<p></p>
                                        <p>(b) Usage</p></td>
                                    <td width="291">Necessary for our legitimate interests (to define types of customers for our products and services, to keep our website updated and relevant, to develop our business and to inform our marketing strategy)</td>
                                </tr>
                                <tr>
                                    <td width="237">To make suggestions and recommendations to you about goods or services that may be of interest to you</td>
                                    <td width="184">(a) Identity<p></p>
                                        <p>(b) Contact</p>
                                        <p>(c) Technical</p>
                                        <p>(d) Usage</p>
                        ...
                        <p>You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please see ( <a href="https://www.luckydaycompetitions.com/terms-of-use/#cookies"><em>https://www.luckydaycompetitions.com/terms-of-use/#cookies</em></a> ).</p>
                        <p>&nbsp;</p>
                        ...
                        <p>&nbsp;</p>
                        <ol start={5}>
                            <li><strong><a></a>Disclosures of your personal data</strong></li>
                        </ol>
                        ...
                        <p>&nbsp;</p>
                        <ol start={9}>
                            <li><strong><a></a>Your legal rights</strong></li>
                        </ol>
                        ...
                        <ul>
                            <li>Service providers acting as processors based in United Kingdom who provide IT and system administration services.</li>
