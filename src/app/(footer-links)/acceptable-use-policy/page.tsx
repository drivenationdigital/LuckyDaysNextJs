...
export const metadata: Metadata = {
    title: "Acceptable Use Policy - Lucky Day Competitions",
    description: "Explore the acceptable use policy of our exciting competitions and see who has won amazing prizes!",
    icons: {
            ...
            <main className="content-page">
                <div className="container text-center">
                    <div className="col-sm-12">
                        ...
                        <p>This acceptable use policy sets out the terms between you and us under which you may access our website <a href="http://www.luckydaycompetitions.com">www.luckydaycompetitions.com</a> (our site). This acceptable use policy applies to all users of, and visitors to, our site.</p>
                        <p>Your use of our site means that you accept, and agree to abide by, all the policies in this acceptable use policy, which supplement our terms of website use <a href="https://www.luckydaycompetitions.com/terms-of-use/">https://www.luckydaycompetitions.com/terms-of-use/</a></p>
                        <p>Our site is a site operated by Ace Competition Limited trading as Lucky Day Competitions (“We”). We are registered in Northern Ireland under company number NI659574 and have our registered office at 72 Tievecrom Road, Forkhill, Newry, Co. Down, BT35 9RX.</p>
                        <p>To contact us, please email <a href="mailto:info@luckydaycompetitions.com">info@luckydaycompetitions.com</a> .</p>
                        <p>&nbsp;</p>
                        <p><strong>Prohibited uses</strong></p>
                        <p>You may use our site only for lawful purposes.&nbsp; <strong>You may not use our site:</strong></p>
                        <ul>
                        ...
                        <ul>
                            <li>Not to reproduce, duplicate, copy or re-sell any part of our site in contravention of the provisions of our terms of website use <a href="https://www.luckydaycompetitions.com/terms-of-use/">https://www.luckydaycompetitions.com/terms-of-use/</a></li>
                        ...
                        <p>We may from time to time provide interactive services on our site, for example, the ability to participate in games, competitions, comment on blog posts or post to our social media accounts (interactive services).</p>
                        ...
                        <p>Failure to comply with this acceptable use policy constitutes a material breach of the terms of use <a href="https://www.luckydaycompetitions.com/terms-of-use/">https://www.luckydaycompetitions.com/terms-of-use/</a> upon which you are permitted to use our site, and may result in our taking all or any of the following actions:</p>
                        <ul>
